...
excerpt: "모듈 1(서비스 기획과 바이브 코딩)의 팀 프로젝트 결과물. 4인 팀 '인사팀'이 기획 문서, 5개 전문 Agent, 337개 커밋을 거쳐 완성한 AI 동선 플래너 — 잘된 점만큼 브랜치 전략 실패와 되돌림 사고까지 그대로 기록했다."
layout: single
categories: [Projects]
module: 1
tags: [서비스기획, 바이브코딩, Next.js, Vercel, Claude Design, 팀프로젝트]
