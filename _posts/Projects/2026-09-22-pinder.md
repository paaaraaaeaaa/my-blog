...
banner_emoji: "🧭"
banner_gradient: "linear-gradient(135deg, #1a73e8, #6ec6ff)"
date: 2026.09.22
comments: true
toc: true
toc_sticky: true
...
.project-hero {
  ...
  margin: 0 0 1.8rem;
  border-radius: 16px;
  background: linear-gradient(135deg, rgba(26,115,232,.08), rgba(110,198,255,.12));
...
.project-hero__body { flex: 1; min-width: 220px; }
.project-hero__title { font-size: 1.2rem; font-weight: 800; margin: 0 0 .3rem; }
.project-hero__desc { font-size: .9rem; color: #555; margin: 0; }
.project-hero__meta { display: flex; flex-wrap: wrap; gap: .4rem .8rem; margin-top: .6rem; font-size: .78rem; color: #666; }
.project-hero__links { display: flex; flex-wrap: wrap; gap: .6rem; margin-top: .9rem; }
.project-hero__link {
  display: inline-flex;
  align-items: center;
  gap: .4rem;
...
.project-hero__link:hover { background: #1558b0; }
.project-hero__link--ghost {
  background: transparent;
  color: #1a73e8 !important;
  border: 1px solid rgba(26,115,232,.35);
}
.project-hero__link--ghost:hover { background: rgba(26,115,232,.08); }
</style>
